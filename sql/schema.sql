...
--
-- For a fresh install with all migrations applied, prefer:
--   sql/bantaypurrpaws_import.sql
--
-- To import production data (InfinityFree dump), use:
--   bantaypurrpaws.sql  (MariaDB-compatible collation)
