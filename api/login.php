...
// Browser client — secure login flow required (no direct session login)
echo json_encode([
    'success' => false,
    'message' => 'Direct login is disabled. Use the secure sign-in flow at login.php.',
    'require_secure_flow' => true,
]);
exit;
